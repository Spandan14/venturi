...
template <typename Q, typename... Params> struct IVPSolvers {
  static Q eulerSolver(Q q0, double t0, double h,
                       Q (*dq_dt)(Q, double, Params...), Params... values) {
    return q0 + h * dq_dt(q0, t0, values...);
  }

  static Q midpointSolver(Q q0, double t0, double h,
                          Q (*dq_dt)(Q, double, Params...), Params... values) {
  ...
  static Q rk4Solver(Q q0, double t0, double h,
                     Q (*dq_dt)(Q, double, Params...), Params... values) {
  ...
  static Q solveIVP(IVPSolverType solver, Q q0, double t0, double h,
                    Q (*dq_dt)(Q, double, Params...), Params... values) {
    switch (solver) {
    case EULER:
